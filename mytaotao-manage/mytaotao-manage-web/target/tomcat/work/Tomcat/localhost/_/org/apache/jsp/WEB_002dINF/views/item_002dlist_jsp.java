 ...
 * Generated at: 2016-01-02 15:54:51 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \t\tonLoad :function(){//页面加载完成之后执行，onload是window的一个事件window.onload（dom的onload与EasyUI的window的事件onload不是一样的\r\n");
      out.write("        \t\t\t//回显数据\r\n");
      ...
      out.write("        \t\t\t\t//通过富文本编辑器的html方法进行回显数据\r\n");
