 ...
 * Generated at: 2015-12-14 08:43:54 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tonContextMenu: function(e,node){//右键的事件\r\n");
      out.write("            e.preventDefault();//阻止默认事件的执行\r\n");
      out.write("            $(this).tree('select',node.target); //选中当前节点\r\n");
      ...
      out.write("        \t\t\t//新增成功之后返回正式id对当前节点的id做update\r\n");
      out.write("        \t\t\t_tree.tree(\"update\",{\r\n");
      out.write("        \t\t\t\ttarget : node.target,\r\n");
      out.write("        \t\t\t\tid : data.id  //数据库新增id\r\n");
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t});\r\n");
      out.write("        \t}else{\r\n");
      out.write("        \t\t$.ajax({\r\n");
      ...
      out.write("            data: [{\r\n");
      out.write("                text: '新建分类',\r\n");
      out.write("                id : 0,//临时的id\r\n");
      out.write("                parentId : node.id\r\n");
      out.write("            }]\r\n");
      out.write("        }); \r\n");
      out.write("\t\tvar _node = tree.tree('find',0);//通过0查找新加节点\r\n");
      out.write("\t\t //选中并且开始编辑\r\n");
