 ...
 */
function login() {
    return location.href = "http://sso.mytaotao.com/user/login.html";
}
function regist() {
    return location.href = "http://sso.mytaotao.com/user/register.html";
}
...
function search(a) {
    var b = "http://www.mytaotao.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
